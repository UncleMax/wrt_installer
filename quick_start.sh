...
function install_panel() {
    ...
    if [ "$BRANCH" == "2" ]; then
        download_file https://raw.githubusercontent.com/UncleMax/wrt_installer/refs/heads/wrt_1panel/install.sh install.sh
        download_file https://raw.githubusercontent.com/UncleMax/wrt_installer/refs/heads/wrt_1panel/1pctl 1pctl
